...
//Funtion to place the marker for next player at a random spot
function placeRandom() {
    var boardSize = gameBoard.getSize();
    return Math.floor(Math.random() * (boardSize - 0 + 1)) + 0;
...
router.get("/", (req, res) => {
    ...
    res.write("Welcome the GomokuBoard server. This is the API of what can be done.\n\n"
        ...
        + " /place/random Place a marker at a random place.\n"
    );
    res.end();
});
